          ...
          allMessages.map((msg,index)=>{
            return(
              <div className={`p-1 py-1 rounded w-fit max-w-[280px] md:max-w-sm lg:max-w-md ${user._id === msg.msgByUserId ? "ml-auto bg-teal-100" : "bg-white"} `}>
                ...
                <p className='text-xs ml-auto width-fit'>{moment(msg.createdAt).format('hh:mm')}</p>
              </div>
            )
          })
        }
        ...
        {/* uploaded image display */}
        {
          message.imageUrl && (
            ...
            <div className='w-full h-full sticky bottom-0 bg-slate-700 bg-opacity-30 flex justify-center items-center rounded overflow-hidden'>
              <div className='w-fit p-2 absolute top-0 right-0 cursor-pointer hover:text-red-600' onClick={handleClearImage}><IoClose size={30} /></div>
    ...
    {/* uploaded video display */}
        {
          message.videoUrl && (
            ...
            <div className='w-full h-full sticky bottom-0 bg-slate-700 bg-opacity-30 flex justify-center items-center rounded overflow-hidden'>
              <div className='w-fit p-2 absolute top-0 right-0 cursor-pointer hover:text-red-600' onClick={handleClearVideo}><IoClose size={30} /></div>
              <div className='bg-white p-3 '>
              <video
        ...
        <div className='relative '>
          ...
          {/* popup for video and image */}
          {
            ...
            <form>
              ...
              <label htmlFor='uploadVideo' className='flex items-center p-2 px-3 gap-3 rounded hover:bg-slate-200 cursor-pointer'>
